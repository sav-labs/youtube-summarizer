...
- НЕ ДОБАВЛЯЙ решетки (##) внутри заголовков секций - используй их только в начале строки для обозначения заголовка
- НЕ ДОБАВЛЯЙ никаких атрибуций к эмодзи (например, "Эмодзи предоставлены OpenMoji") в конце обзора
- НЕ ДОБАВЛЯЙ никаких дополнительных сносок или примечаний в конце обзора
"""
...
9. ВАЖНО: НЕ ИСПОЛЬЗУЙ решетки (##) внутри заголовков секций - используй их только в начале строки
10. ВАЖНО: НЕ ДОБАВЛЯЙ никаких атрибуций к эмодзи или других примечаний и сносок в конце обзора
...
DEFAULT_SYSTEM_PROMPTS = {
    "summarizer": {
        "content": "Ты аналитик видеоконтента. Твоя задача - создавать краткие, информативные и структурированные обзоры на основе транскрипций видео. Выделяй главное, отбрасывай второстепенное. Обязательно используй эмодзи для каждого раздела и форматируй текст строго по Markdown. НЕ добавляй атрибуцию для эмодзи (например, OpenMoji) и не добавляй символы форматирования (#, ##, **, *) внутри самих заголовков, только в начале строки.",
